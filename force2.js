...
// node.append('text').text('yo')
//   .attr('x', function(d){console.log(parseInt(d.x)); return parseInt(d.x)})
//   .attr('y', function(d){console.log(parseInt(d.y)); return parseInt(d.y)})
    ...
    force.on("tick", function() {
     ...
     //    .attr("y2", function(d) { return d.target.y; });
      link.attr('d', function(d){
        ...
        " T " + parseInt(1 * (d.target.x + d.source.x)/2  ).toString() + " " + parseInt(1 * (10 + d.target.y + d.source.y)/2).toString() +

        " T " + parseInt(1 * d.target.x).toString() + " " + parseInt(1 * d.target.y).toString() + " Z"
